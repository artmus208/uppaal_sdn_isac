...
def main():
 ...
 hardware=subprocess.run([PS,'-NoProfile','-Command',"$os=Get-CimInstance Win32_OperatingSystem; $cpu=Get-CimInstance Win32_Processor; @{os=$os.Caption;version=$os.Version;ram_bytes=([long]$os.TotalVisibleMemorySize*1024);cpu=@($cpu|Select-Object Name,NumberOfCores,NumberOfLogicalProcessors)}|ConvertTo-Json -Depth 4"],capture_output=True,timeout=30)
