...
A[] not deadlock
// queue-capacity -- candidate, no verdict
A[] !mac_queue_overflow_seen
// queue-nonempty -- candidate, no verdict
E<> mac_queue_q > 0
// queue-full -- candidate, no verdict
E<> mac_queue_q == mac_queue_K && !mac_queue_overflow_seen
// queue-overflow -- candidate, no verdict
E<> mac_queue_overflow_seen
// recovery-attempts-bounds -- candidate, no verdict
A[] !sdn_attempt_bad
// recovery-attempts-protocol -- candidate, no verdict
A[] !sdn_attempt_protocol_error
// recovery-attempts-start -- candidate, no verdict
E<> sdn_attempt_active
// recovery-attempts-primary -- candidate, no verdict
E<> sdn_attempt_primary == 1
// recovery-attempts-rollback -- candidate, no verdict
E<> sdn_attempt_rollback == 1
// recovery-attempts-two -- candidate, no verdict
