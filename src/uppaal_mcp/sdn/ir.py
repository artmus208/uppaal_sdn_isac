...
@dataclass(frozen=True)
class SdnContractModel:
    source_name: str
    layer_id: str
    sdn_components: list[str]
    ...
    interfaces: list[InterfaceProcedureSpec]
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "SdnContractModel":
        ...
        return cls(
            ...
            layer_id=data.get("layer_id", "sdn"),
            sdn_components=list(data["sdn_components"]),
