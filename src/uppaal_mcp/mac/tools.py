...
def extract_contract(*, tex_text: str | None = None, tex_path: str | None = None) -> dict:
    ...
    contract["extractor"] = {
        ...
        "diagnostics": ["No MAC LaTeX source was provided or found; returned canonical MAC fixture."],
    }
    return contract
...
def generate_uppaal_from_contract(
    *,
    ...
    semantic = validate_generated_model(
        generated.model_xml,
        generated.queries,
        require_observers="ObsPhyAck" in generated.model_xml,
...
def export_diagram(*, output_dir: str, model_xml: str | None = None, contract_json: dict | None = None, tex_text: str | None = None, tex_path: str | None = None, profile: dict | None = None, layout: str | None = None) -> dict:
    ...
    files = []
    for name in ("model_map.md", "template_map.md", "channels_map.md", "policy_map.md", "model.dot", "model.svg"):
...
def verify_contract(*, tex_text: str | None = None, tex_path: str | None = None, contract_json: dict | None = None, profile: dict | None = None, mode: str | None = None, include_observers: bool = True, timeout_sec: float | None = None, artifact_root: str | None = None, force: bool = False) -> dict:
    ...
    artifacts = export_run_artifacts(output_root=artifact_root or str(runner.config.workspace / "mac_runs"), contract_json=generated["contract"], tex_text=source_text, model_xml=generated["model_xml"], queries=generated["queries"], result_json=result, profile=generated["profile"], force=force)
...
def mac_verify_scenario(name: str, profile: dict | None = None, timeout_sec: float | None = None) -> dict:
...
def mac_verify_all_scenarios(profile: dict | None = None, timeout_sec: float | None = None) -> dict:
    results = [mac_verify_scenario(item["name"], profile=profile, timeout_sec=timeout_sec) for item in list_scenarios()]
...
def mac_list_classes() -> dict[str, list[str]]:
    return list_classes()
